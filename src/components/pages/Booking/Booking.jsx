                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        <div className="flex items-center">
                            <div className="lg:w-1/3">
                                <BookingItem label="Pickup Location" type="select" id="pickupLocation" name="pickupLocation"
                                    options={[
                            ...
                            <div className="lg:w-1/3 pl-4">
                                <BookingItem label="Drop-off Location" type="select" id="dropOffLocation" name="dropOffLocation"
                                    options={[
                            ...
                            <div className="lg:w-1/3 pl-4">
                                <BookingItem label="Select A Car" type="select" id="carType" name="carType"
                                    options={[
                                        "Select A Car",
                                        "Audi S1",
                                        "BMW IX",
                        ...
                        <div>
                            <button type="submit" className="w-full hover:text-red-500 hover:bg-gray-100 transition ease-out duration-200 text-md text-gray-50 font-bold bg-red-500 border-red-500 border-2 border-red-500 px-4 py-2 rounded">
                                Book Now
                            </button>
                        </div>
                    </form>
